...
public class PlayerCoverController : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (IsInCover)
        {
            if (activeCover == null)
            {
                if (logCoverDebug)
                {
                    Debug.LogWarning("Cover object was removed. Exiting cover state automatically.");
                }
    ...
    private void TryEnterCover()
    {
        ...
        if (nearestCoverCollider == null)
        {
            if (logCoverDebug)
            {
                Debug.Log("No valid cover found nearby when pressing E.");
            }
        ...
        if (logCoverDebug)
        {
            Debug.Log("Entered cover at: " + activeCoverSnapPosition);
        }
    ...
    private void UpdatePeekState()
    {
        ...
        if (peekInput && !IsPeekingFromCover)
        {
            ...
            if (logCoverDebug)
            {
                Debug.Log("Started peeking from cover.");
            }
        ...
        else if (!peekInput && IsPeekingFromCover)
        {
            ...
            if (logCoverDebug)
            {
                Debug.Log("Stopped peeking. Back to hidden cover.");
            }
